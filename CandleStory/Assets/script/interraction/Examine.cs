...
public class Examine : MonoBehaviour
{
    ...
    public float interactDistance = 0f; //Distance pour une interaction avec Objet
    bool examineMode;
    ...
    void ClickObject()
    {
...

        {
            ...
            if (Physics.Raycast(ray, out hit, interactDistance, movableLayer))
            {
                ...
                clickedObject.transform.position = mainCam.transform.position + (transform.forward * Zoom);
